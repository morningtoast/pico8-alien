...
function generate_map(w,h)
	...
	for x=1,map_tilew do
		...
		for y=1,map_tileh do
			local obj={
				...
				occupant="empty",flip=false,
				hbox={x=2,y=2,w=13,h=13},
				w=true --is space walkable? true=open,false=blocked
			}	
		
			obj.x,obj.y=tile_to_px(x,y)
			obj.cx=obj.x+8
			obj.cy=obj.y+8
	...
	-- map border walls. decoration only, no used in grid or pathfinding
	border={}
	for m=0,flr(map_hpx/16)+1 do
		local spr=rnd_table({3,34,68})
		
		add(border,{x=-15,y=(15*m),s=spr})
		add(border,{x=map_wpx+1,y=(15*m),s=spr})
	end
	
	for m=0,flr(map_wpx/16)+1 do
		local spr=rnd_table({3,34,68})
		
		add(border,{x=(15*m),y=-15,s=spr})
		add(border,{x=(15*m),y=map_hpx+1,s=spr})
	end
	...
	for spx=0,7 do
		for spy=0,7 do
			...
			if pxc==11 or pxc==3 then 
				...
				if pxc==11 then if rnd()<.5 then tile.flip=true end end
			end
			
			--rock/wall
			if pxc==6 then 
				tile.spr=rnd_table({38,102})
				tile.occupant="wall"
				tile.w=false
			end
...
function minimap_dot(x,y,c)
	...
	y1=((y-1)*minimap_size)+minimap_y
	x2=((x-1)*minimap_size)+minimap_size+minimap_x
	y2=((y-1)*minimap_size)+minimap_size+minimap_y
...
function _draw()
	...
	for x=1,map_tilew do
		for y=1,map_tileh do
			...
			if plot.occupant=="wall" then
				spr(plot.spr, plot.x, plot.y, 2,2, plot.flip)
			end
			
			if plot.occupant=="sniper" then
				spr(66, plot.x, plot.y, 2,2, plot.flip)
			end
			
			if plot.occupant=="body" then
				spr(7,plot.x,plot.y+3,2,1)
			end
			
			if plot.occupant=="egg" then
				spr(36,plot.x,plot.y,2,2)
			end
	...
	print("there are 3 eggs remaining, hurry!",uix,120, 6)
	
	rectfill(90,117, 127,127, 5)
	rect(0,117, 90,127,5) 
	
	
	--battery - make this a sprite?
	...
	--[[
	rectfill(92,120, 98,124, battc)
	line(99,121, 99,123, battc)
	pset(93,121,1)pset(94,121,1)
	pset(95,122,1)
	pset(96,123,1)pset(97,123,1)]]
	
	spr(16, 108,119) --egg icon
	print("99",118,120, 6)
	
	uix-=.8
	if uix<=-130 then uix=100 end	
	
	
	--rect(0,0, map_wpx,map_hpx, 5)
	
	--[[
	
	for n=0,map_w*8 do
		line(n*16,0, n*16,127, 5)	
	end
	
	for n=0,map_h*8 do
		line(0,n*16, 127,n*16, 5)	
	end
	]]
	...
	if debug then print(debug, 6,6, 1) print(debug, 5,5, 7) end
end
...
__gfx__

...

...

...

